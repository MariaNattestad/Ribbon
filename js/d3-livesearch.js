...
export const Livesearch = function () {
  ...
  function my(selection) {
    selection.each(function (d, i) {
      ...
      if (d != undefined) {
        ...
        this.search_list =
          typeof search_list === "function" ? search_list(d) : search_list;
        if (this.search_list == undefined && d.search_list != undefined) {
          this.search_list = d.search_list;
        }
        this.search_key =
          typeof search_key === "function" ? search_key(d) : search_key;
        if (this.search_key == undefined && d.search_key != undefined) {
          this.search_key = d.search_key;
        }
        this.max_suggestions_to_show =
          typeof max_suggestions_to_show === "function"
            ? max_suggestions_to_show(d)
        ...
        placeholder_text =
          typeof placeholder === "function" ? placeholder(d) : placeholder;
      } else {
      ...
      element
        .append("input")
        .property("type", "text")
        .attr("class", "d3-livesearch-input")
        .on("keyup", my.typing)
        .property("placeholder", placeholder_text);
  ...
  my.typing = function () {
    ...
    if (key == 13) {
      ...
      if (
        this.parentNode.highlighted_index >= this.parentNode.num_suggestions
      ) {
      ...
      parent
        ...
        .selectAll("li")
        .attr("class", function (d, i) {
          return i == h ? "selected" : "unselected";
        });
      return;
    } else if (key == 38) {
      // up arrow
    ...
    if (search_key != undefined) {
      for (var i in search_list) {
        if (search_list[i][search_key] == undefined) {
          ...
          if (
            max_suggestions_to_show != undefined &&
            this.parentNode.num_suggestions >= max_suggestions_to_show
          ) {
            break;
          }
        }
    ...
    parent
      ...
      .append("li")
      .html(function (d) {
        return typeof d === "string" ? d : d[search_key];
      })
      .attr("class", function (d, i) {
        return i == h ? "selected" : "unselected";
      })
